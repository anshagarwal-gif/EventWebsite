...
import musicEventImage1 from './Assets/Music 1.svg'
import musicEventImage2 from './Assets/Music 2.svg'
import musicEventImage3 from './Assets/Music 3.svg'
import musicEventImage4 from './Assets/Music 4.svg'
import CorporateEvent1 from './Assets/Corporate 1.svg';
import CorporateEvent2 from './Assets/Corporate 2.svg';
import CorporateEvent3 from './Assets/Corporate 3.svg';
import CorporateEvent4 from './Assets/Corporate 4.svg';
...
import concert1 from './Assets/13.svg'; 
import concert2 from './Assets/14.svg';
import concert3 from './Assets/15.svg';
import concert4 from './Assets/16.svg';
import summit1 from './Assets/Summit 1.svg';
import summit2 from './Assets/Summit 2.svg';
import summit3 from './Assets/Summit 3.svg';
import summit4 from './Assets/Summit 4.svg';
      ...
      <div className="whatwedo-event-tabs">
        ...
        {activeTab === 1 && (
          <>
            ...
            <div className='image-grid'>
              <div>
                <img src={CorporateEvent1} alt="image1" className='eventImage' />
              </div>
              <div>
                <img src={CorporateEvent2} alt="image2" className='eventImage' />
              </div>
              <div>
                <img src={CorporateEvent3} alt="image3" className='eventImage' />
              </div>
              <div>
                <img src={CorporateEvent4} alt="image4" className='eventImage' />
              </div>
            </div>
        ...
        {activeTab === 5 && (
          <>
            ...
            <div className='image-grid'>
              <div>
                <img src={summit1} alt="image1" className='eventImage' />
              </div>
              <div>
                <img src={summit2} alt="image2" className='eventImage' />
              </div>
              <div>
                <img src={summit3} alt="image3" className='eventImage' />
              </div>
              <div>
                <img src={summit4} alt="image4" className='eventImage' />
              </div>
            </div>
